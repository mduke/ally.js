define(function(require) {
  ...
  bdd.describe('element/disabled', function() {
    ...
    bdd.describe('for SVG elements', function() {
      bdd.it('should set focusable="false"', modifiesAttribute('svg-link', 'focusable', supports.canFocusSvgFocusableAttribute ? 'false' : null, null));
      bdd.it('should overwrite focusable="true"', modifiesAttribute('svg-text', 'focusable', supports.canFocusSvgFocusableAttribute ? 'false' : 'true', 'true'));
      bdd.it('should set focusable="false" on <svg>', modifiesAttribute('svg', 'focusable', supports.canFocusSvgFocusableAttribute ? 'false' : null, null));
